...
export const OrdersAddForm = () => (
	<>
					...
					<CardContent>
						<div className="grid gap-2">
							<Image
								...
								height="300"
								src="/product-placeholder-image.svg"
								width="300"
							/>
							<div className="grid grid-cols-3 gap-2">
								...
								<button className="flex aspect-square w-full items-center justify-center rounded-md border border-dashed" type="button">
		...
		<div className="flex pt-4 items-center justify-end gap-2 md:hidden">
			<Button variant="outline">Discard</Button>
			<Button>Save order</Button>
		</div>
	</>
